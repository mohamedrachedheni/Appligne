...
urlpatterns = [
    ...
    path('demande_cours_recu_eleve', views.demande_cours_recu_eleve, name='demande_cours_recu_eleve'),
    path('reponse_email', views.reponse_email, name='reponse_email'),
    ...
    path('modifier_mes_eleve', views.modifier_mes_eleve, name='modifier_mes_eleve'),
    ...
    path('horaire_cours_mon_eleve', views.horaire_cours_mon_eleve, name='horaire_cours_mon_eleve'),
    path('liste_seance_cours', views.liste_seance_cours, name='liste_seance_cours'),
    path('demande_reglement', views.demande_reglement, name='demande_reglement'),
    path('declaration_cours', views.declaration_cours, name='declaration_cours'),
    path('liste_declaration_cours', views.liste_declaration_cours, name='liste_declaration_cours'),
    path('detaille_demande_reglement', views.detaille_demande_reglement, name='detaille_demande_reglement'),
    ...
    path('temoignage_detaille', views.temoignage_detaille, name='temoignage_detaille'),
