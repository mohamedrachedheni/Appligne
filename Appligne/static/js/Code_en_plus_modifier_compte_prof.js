...
function configurerPikaday() {
    ...
    var picker = new Pikaday({
        ...
        onSelect: function (date) {
            ...
            document.getElementById('date_naissance_id').value = formattedDate;
        }
    });
};
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var dateInput = document.getElementById('date_naissance_id');
